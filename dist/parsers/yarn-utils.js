...
exports.yarnLockFileKeyNormalizer = exports.normalizeDepRange = exports.parseDepName = void 0;
...
function normalizeDepRange(version) {
    return version.replace('npm:', '');
}
exports.normalizeDepRange = normalizeDepRange;
